package person.zhangyu.cola.domain.customer;

import com.alibaba.cola.domain.Entity;
import com.alibaba.cola.exception.BizException;
import lombok.Data;

import person.zhangyu.cola.dto.domainmodel.*;

//Domain Entity can choose to extends the domain model which is used for DTO
@Data
@Entity
public class Customer extends person.zhangyu.cola.dto.domainmodel.Customer{
